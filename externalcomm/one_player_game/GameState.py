...
class GameState:
    ...
    # Game State Update
    def update_players(self, p1_action: str, p2_action: str):
        p1_action_valid = self.player_1.action_is_valid(p1_action)
        p2_action_valid = self.player_2.action_is_valid(p2_action)
        self.player_1.update(0, 0, p1_action, p2_action, p2_action_valid)
        self.player_2.update(0, 0, p2_action, p1_action, p1_action_valid)
